  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        style={{ background: "linear-gradient(90deg, transparent, #E0C58F, transparent)" }}
      />
...
function CinematicExperience() {
  ...
  const activeColor = active >= 1 ? CHAPTERS[active - 1].color : "#E0C58F";
    ...
    >
      <div className="mx-auto max-w-5xl">
        <div className="mb-16 text-center">
          <p className="font-mono-custom text-xs uppercase tracking-[0.4em] text-[#E0C58F]">
            Experience
          </p>
