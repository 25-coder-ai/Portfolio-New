  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        style={{ background: "linear-gradient(90deg, transparent, #A07856, transparent)" }}
      />
...
function CinematicExperience() {
  ...
  const activeColor = active >= 1 ? CHAPTERS[active - 1].color : "#A07856";
    ...
    >
      <div className="mx-auto max-w-5xl">
        <div className="mb-16 text-center">
          <p className="font-mono-custom text-xs uppercase tracking-[0.4em] text-[#A07856]">
            Experience
          </p>
