...
function ContactForm() {
  ...
  const field =
    "w-full rounded-xl border border-white/[0.08] bg-[#1A2540] px-4 py-3 text-sm text-[#E8EEFF] placeholder:text-[#4A5568] outline-none transition-all duration-200 focus:border-[#A07856]/60 focus:ring-2 focus:ring-[#A07856]/25";
