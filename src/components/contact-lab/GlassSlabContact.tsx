...
function ContactCard({
  ...
  return (
    <motion.a
      ...
      whileHover={{ y: -3 }}
      whileTap={{ scale: 0.99 }}
      className="group flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3.5 transition-colors duration-300 hover:border-white/20 hover:bg-white/[0.09] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A07856]/70 sm:px-5"
    >
      ...
      <ArrowRight
        size={18}
        className="shrink-0 text-[#8892A4] transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#A07856]"
      />
    </motion.a>
  );
}
