      ...
      >
        ...
        >
          <div className="rounded-[30px] border border-white/10 bg-white/[0.05] px-7 py-9 text-center backdrop-blur-2xl sm:px-10 sm:py-11">
            <GlassSheen />
            <RimLight />
            <p className="relative text-[11px] font-medium uppercase tracking-[0.35em] text-[#A07856]/80">
              Contact
            </p>
...
function LinkCard({
  ...
  return (
    <motion.a
      ...
      whileHover={{ y: -4 }}
      whileTap={{ scale: 0.98 }}
      className="group relative flex flex-col justify-between gap-6 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.05] p-4 backdrop-blur-xl transition-colors duration-300 hover:border-white/25 hover:bg-white/[0.10] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A07856]/70"
    >
      <RimLight />
      <div className="relative flex items-start justify-between">
        ...
        <ArrowUpRight
          size={18}
          className="text-[#8892A4] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[#A07856]"
        />
      </div>
...
function ContactForm() {
  ...
  const field =
    "w-full rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-[#E8EEFF] placeholder:text-[#4A5568] outline-none transition-all duration-200 focus:border-[#A07856]/60 focus:bg-white/[0.07] focus:ring-2 focus:ring-[#A07856]/30";
  ...
  return (
    <form onSubmit={submit} className="relative space-y-3">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#A07856] to-[#A78BFA] px-5 py-3 text-sm font-medium text-white shadow-[0_14px_36px_-12px_rgba(79,142,247,0.7)] transition-shadow duration-300 hover:shadow-[0_18px_46px_-10px_rgba(79,142,247,0.85)]"
      >
