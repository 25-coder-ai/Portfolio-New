      ...
      >
        ...
        >
          <div className="rounded-[30px] border border-white/10 bg-white/[0.05] px-7 py-9 text-center backdrop-blur-2xl sm:px-10 sm:py-11">
            <GlassSheen />
            <RimLight />
            <p className="relative text-[11px] font-medium uppercase tracking-[0.35em] text-[#E0C58F]/80">
              Contact
            </p>
...
function LinkCard({
  ...
  return (
    <motion.a
      ...
      whileHover={{ y: -4 }}
      whileTap={{ scale: 0.98 }}
      className="group relative flex flex-col justify-between gap-6 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.05] p-4 backdrop-blur-xl transition-colors duration-300 hover:border-white/25 hover:bg-white/[0.10] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E0C58F]/70"
    >
      <RimLight />
      <div className="relative flex items-start justify-between">
        ...
        <ArrowUpRight
          size={18}
          className="text-[#8892A4] transition-all duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-[#E0C58F]"
        />
      </div>
