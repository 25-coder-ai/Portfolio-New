// Where the keyboard sits / how big it is / how it is rotated for each page
// section. The component tweens the Spline "keyboard" object between these
// states as you scroll. If you only want a single static keyboard, you can keep
// just the `skills` entry and ignore the scroll wiring in the component.
